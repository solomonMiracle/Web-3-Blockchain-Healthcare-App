...
const CreateCampaign = () => {
  ...
  return (
    <div className="bg-[black] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      {isLoading && <Loader />}
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[red] rounded-[10px]">
      ...
      <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
        ...
        <div className="w-full flex justify-start items-center p-4 bg-[black] h-[120px] rounded-[10px]">
          ...
          <h4 className="font-epilogue font-bold text-[25px] text-white ml-[20px]">Donators are Usually willing to contribute to ideal Projects that help, saves and improve lives</h4>
        </div>
